...
/**
 * DesembolsoDetalleSearch represents the model behind the search form about `app\models\RecursoProgramado`.
 */
class DesembolsoDetalleSearch extends RecursoProgramado
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        $query = RecursoProgramado::find()
                        ->select('recurso_programado.anio, recurso_programado.mes, sum(recurso.precio_unit*recurso_programado.cantidad) as cantidad2, recurso_programado.estado')
