...
class RecursoProgramadoSearch extends RecursoProgramado
{
    ...
    public function search($params)
    {
        $query = RecursoProgramado::find()
                        ->select('recurso_programado.anio, recurso_programado.mes, round(sum(recurso.precio_unit*recurso_programado.cantidad),2) as cantidad, min(recurso_programado.estado) as estado')
